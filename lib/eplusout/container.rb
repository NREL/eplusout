module EPlusOut
  class Container
    ...
    def self.default_configuration(sql_file)
      ...
      container.relations[:engineering_checks_for_cooling] = Relations::EngineeringCheckForCoolings.new(gateway)
      container.relations[:engineering_checks_for_heating] = Relations::EngineeringCheckForHeatings.new(gateway)
